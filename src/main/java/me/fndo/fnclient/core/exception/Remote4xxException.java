 ...
 * 远程调用 4xx 异常
 * <p>
 * 表示客户端错误状态码（400-499），通常由请求参数错误或资源不存在导致。
 *
 * @author sim
 */
public class Remote4xxException extends RemoteCallException {

    private static final long serialVersionUID = 1L;

    private static final String ERROR_MESSAGE_PREFIX = "Remote 4xx Client Error";

    public Remote4xxException(int statusCode, String uri, String body) {
        super(statusCode, uri, body);
    }

    public Remote4xxException(int statusCode, String uri, String body, Throwable cause) {
