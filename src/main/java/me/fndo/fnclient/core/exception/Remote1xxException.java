 ...
 * @author sim
 */
public class Remote1xxException extends RemoteCallException {

    private static final long serialVersionUID = 1L;

    private static final String ERROR_MESSAGE_PREFIX = "Remote 1xx Informational Error";

    public Remote1xxException(int statusCode, String uri, String body) {
        super(statusCode, uri, body);
    }

    public Remote1xxException(int statusCode, String uri, String body, Throwable cause) {
